...
export async function createBookingHold({ sizeYards, startDate, endDate, customerId = null, holdType = "online_checkout", holdMinutesOverride = null, source = "funnel", metadata = {} } = {}) {
  ...
  const attempts = [
    ...
    { hold_type: holdType, status: "active", size_code: normalizedSizeCode, size_yards: normalizedSizeYards, dropoff_date: start, scheduled_return: end, expires_at: expiresAt, source, metadata },
  ];
